...
import onSubmit from "../../layouts/authentication/sign-in/index"
    ...
    >
      <MDBox pt={3} pb={1} px={4} textAlign="center">
        ...
        <MDBox component={NavLink} to="/dashboard" display="flex" alignItems="center">
          ...
          >
            <MDTypography component="h6" variant="text" fontWeight="medium" color={textColor}>
              {brandName}
            </MDTypography>
          </MDBox>
        </MDBox>
